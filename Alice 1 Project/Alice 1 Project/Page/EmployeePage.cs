...
namespace Alice_1_Project.Page
{
    public class EmployeePage
    {
        public void CreateEM(IWebDriver driver)
        {
            ...
            ////Enter Employee Name
            //IWebElement EmployeeName = driver.FindElement(By.XPath("/html/body/div[4]/form/div/div[1]/label"));
            //EmployeeName.SendKeys("Alice");

            ////Enter Username
            //IWebElement EmployeeUsername = driver.FindElement(By.XPath("/html/body/div[4]/form/div/div[2]/label"));
